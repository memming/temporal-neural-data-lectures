...
\title{Introduction to temporal structure in neural data\footnote{Available online: \url{https://github.com/memming/temporal-neural-data-lectures}}}
...
\else
In Python, the function \texttt{scipy.signal.correlate} or some other magic function does the job. However, you have to do the normalization yourself.
...
\question \homework Following code simulates from a GLM. 
\ifMATLAB
