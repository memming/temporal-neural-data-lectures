...
\newpage
    ...
    \vspace{\stretch{3}}
    \part \textbf{MATLAB Homework Q2:} Simulate AR(1) models with $a=0.9$ and $a=-0.9$ and $\sigma=0.01$ for $T=10,000$ time steps. Compute the sample mean and sample variance and plot the sample autocorrelation function. Compare these with the theoretical values you derived above. Is the process \textit{ergodic}, that is, do the time average agree with the expectation?
